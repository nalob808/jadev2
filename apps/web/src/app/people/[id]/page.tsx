...
export default async function PersonPage({
  ...
  /**
   * The chart-specific half of every explained word on this page. Computed
   * once here, beside the chart it describes, rather than recomputed by each
   * tooltip that happens to open.
   */
